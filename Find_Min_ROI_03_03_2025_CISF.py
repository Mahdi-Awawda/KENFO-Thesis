...
plot_dir = "../src/plots_capital_injection"
...
for year in years:
    data = getattr(Data_09_03_2025_CISF, f"Conclusion_in_{year}", [])
...
line_plot_path = get_next_filename("plots_ROI_line_CISF", "png", plot_dir)
...
plt.title("Required ROI Over the Years (CISF)")

# Set x-ticks to display every 5 years
plt.xticks(range(2120, 2181, 5), rotation=45)
